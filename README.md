...
## Installation
Download the [latest release](https://github.com/gtaforever00/pegasus-boy/tags), extract and place in the resulting folder your Pegasus theme directory. In Pegasus, select the theme in the settings menu.
